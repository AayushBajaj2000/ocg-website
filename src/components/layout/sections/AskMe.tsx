...
import { WHATSAPP_HREF, bookingHref } from "@/lib/constants";
  ...
  return (
    <div className="bg-sunken flex flex-col gap-8 p-4 md:gap-12 md:p-6">
      <div className="flex flex-col gap-4 md:gap-6">
        <Reveal delay={delay}>
          <Image src="/logo-filled.svg" alt="" width={64} height={64} />
        </Reveal>
        <div className="flex flex-col gap-1">
          <Reveal as="p" className="text-base font-medium text-black" byLine delay={delay + step}>
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <Reveal as="span" className="text-black-3 mt-4 text-base" byLine delay={delay * 4}>
          or email us:{" "}
          <a href="mailto:info@opencoregroup.com" className="underline underline-offset-2">
